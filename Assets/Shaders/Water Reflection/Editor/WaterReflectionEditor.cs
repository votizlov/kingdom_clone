...
public class WaterReflectionEditor : Editor
{
    ...
    private SerializedProperty projectionTarget;
    ...
    private void OnEnable()
    {
        ...
        projectionTarget = serializedObject.FindProperty("ProjectionTarget");
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(projectionTarget, new GUIContent("ProjectionTarget", "Camera used to capture the reflection scene."));
